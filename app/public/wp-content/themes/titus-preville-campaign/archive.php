    ...
    <div class="container">
            ...
            <div class="news-grid">
                <?php while ( have_posts() ) : the_post(); ?>
                    <article id="post-<?php the_ID(); ?>" <?php post_class( 'news-card' ); ?>>
                        ...
                        <?php else : ?>
                            <div class="news-card-thumbnail" style="background: linear-gradient(135deg,#e8f5ee,#fff3c4);">
                                <div class="news-card-placeholder-thumb" aria-hidden="true">
                                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#007A3D" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="news-card-body">
                            ...
                            <div class="news-card-footer">
                                <a href="<?php the_permalink(); ?>" class="read-more"><?php esc_html_e( 'Read more', 'titus-preville-campaign' ); ?></a>
                            </div>
                        </div>
                    </article>
                <?php endwhile; ?>
        ...
        <?php else : ?>
            <div style="text-align:center; padding:60px 0;">
                <h2><?php esc_html_e( 'No updates yet.', 'titus-preville-campaign' ); ?></h2>
                <p><?php esc_html_e( 'Campaign updates will appear here. Check back soon.', 'titus-preville-campaign' ); ?></p>
